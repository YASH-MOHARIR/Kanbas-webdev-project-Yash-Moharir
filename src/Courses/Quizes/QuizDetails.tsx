...
export default function QuizDetails() {
  ...
  const calculateTotalPoints = () => {
    return quizDetails.questionData.reduce((total, question) => total + question.points, 0);
  };
    ...
    <div className="container mt-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
          ...
          <Link className="wd-quiz-link " to={`/Courses/${cid}/Quizes/${qid}/update`}>
            <button className="btn btn-outline-secondary"><MdEdit  className="mx-2"/>Edit</button>
          </Link>
        </div>
      </div>
      ...
      <div className="row">
        ...
        <div className="d-flex">
          ...
          <p className="col-6">{calculateTotalPoints()}</p>
        </div>
        <div className="d-flex">
        ...
        <div className="d-flex">
          ...
          <p className="col-6">{quizDetails.showCorrectAnswers || "Not Configured"}</p>
        </div>
        <div className="d-flex">
