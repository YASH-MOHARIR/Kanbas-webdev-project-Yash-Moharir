...
export default function Signup() {
  ...
  return (
    <div className="wd-signup-screen">
      <h1>Sign up</h1>
      <input  required={true} value={user.username} onChange={(e) => setUser({ ...user, username: e.target.value })}
             className="wd-username form-control mb-2" placeholder="username" />
      <input required={true} value={user.password} onChange={(e) => setUser({ ...user, password: e.target.value })} type="password"
